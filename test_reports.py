...
There is normal lumbosacral vertebral body height and alignment on this supine, non-weight bearing exam. Vertebral body marrow signal is normal. The conus medullaris is normal and terminates at L1.
...
MRI Lumbar Spine (NEURO) WITH AND WITHOUT CONTRAST

TECHNIQUE: 

Multi-sequence, multi-planar MRI of the Lumbar spine was performed without and with intravenous contrast. 

Multi-sequence, multi-planar MRI of the Lumbar spine was performed without and with intravenous contrast. 

COMPARISON: Brain MRI performed 7/25/2021. Cervical and lumbar spine MRI performed 8/21/2021. 

FINDINGS:
Lumbar Spine:
The patient presents with diffuse degenerative changes throughout the lumbar spine, most pronounced at the L5-S1 disc level. These changes are accompanied by mild disc space narrowing at L5-S1. Facet arthropathy is noted throughout the lumbar spine but remains within normal limits for the patient’s age. No thecal sac compression is observed. The alignment of the lumbar spine is normal.

IMPRESSION: 
1. Degenerative Disc Disease, most prominent at L5-S1.
2. Disc space narrowing at L5-S1.
3. Diffuse facet arthrosis.
"""